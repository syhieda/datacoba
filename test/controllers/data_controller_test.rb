...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference("Datum.count") do
      post data_url, params: { datum: { : @datum., data_nama: @datum.data_nama, nama: @datum.nama } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { : @datum., data_nama: @datum.data_nama, nama: @datum.nama } }
